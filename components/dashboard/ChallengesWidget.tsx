...
import { MoreHorizontal, GraduationCap, CalendarCheck, FlaskConical, Music } from 'lucide-react';
            ...
            <Link key={c.title} href={c.href} className="block shrink-0">
              <div className="flex items-center gap-3 rounded-xl bg-brand-background p-3 transition-colors hover:bg-gray-100">
                ...
                <div className="flex items-center gap-1.5">
                  {c.gems != null && (
                    <span className="text-[11px] font-bold text-brand-ai">+{c.gems} gems</span>
                  )}
                  <span className="text-[11px] font-bold text-brand-accent">+{c.xp} XP</span>
                </div>
                <button
