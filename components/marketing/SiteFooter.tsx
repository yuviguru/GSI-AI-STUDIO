...
const COLUMNS: FooterColumn[] = [
  ...
  },
  {
    title: 'For parents',
    links: [
      { label: 'How it works', href: '#x-ray' },
      { label: 'Safety &amp; privacy', href: '#safety' },
      { label: 'Pricing', href: '#pricing' },
      { label: 'Weekly progress reports', href: '#x-ray' },
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'CBSE AI curriculum', href: '#schools' },
      { label: 'Teacher dashboard', href: '/teacher' },
      { label: 'Lesson plans', href: '/school#lessons' },
      { label: 'Compliance reports', href: '/school#compliance' },
      { label: 'Inter-school competitions', href: '/school#compete' },
    ],
  },
  {
    title: 'Learn',
    links: [
      ...
      { label: 'CBSE alignment', href: '/learn' },
