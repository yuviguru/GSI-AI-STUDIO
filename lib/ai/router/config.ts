...
import type { LlmProvider, ImageProvider, AudioProvider } from '@/lib/ai/ports';
import { makeAnthropicProvider } from '@/lib/ai/adapters/llm/anthropic';
import { makeOpenAiCompatibleProvider } from '@/lib/ai/adapters/llm/openaiCompatible';
import { makePixazoProvider } from '@/lib/ai/adapters/image/pixazo';
import { makeReplicateProvider } from '@/lib/ai/adapters/image/replicate';
import { makePollinationsProvider } from '@/lib/ai/adapters/image/pollinations';
import { makeComfyUiProvider } from '@/lib/ai/adapters/image/comfyui';
import { makeGeminiAudioProvider } from '@/lib/ai/adapters/audio/gemini';
